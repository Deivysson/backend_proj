...
async function insertFile(nome_arquivo, caminho_arquivo, cod_paciente, exame, data_exame, medico) {
    const client = await connect();
    const res = await client.query('INSERT INTO arquivos (nome_arquivo, caminho_arquivo, cod_paciente, exame, data_exame, medico) VALUES ($1, $2, $3, $4, $5, $6)', [nome_arquivo, caminho_arquivo, cod_paciente, exame, data_exame, medico]);
    client.release();
    return res.rowCount;
}
